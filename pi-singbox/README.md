...
```bash
python3 run_all.py --sing-box ./sing-box-1.13.13-linux-arm64/sing-box --secret change-this --web-secret choose-a-web-password
python3 surge2singbox.py run surge_full.conf --sing-box ./sing-box-1.13.13-linux-arm64/sing-box --api-listen 127.0.0.1:9090 --secret change-this --cache-path ./cache.db --local-dns-server 127.0.0.1 --local-dns-port 1053
